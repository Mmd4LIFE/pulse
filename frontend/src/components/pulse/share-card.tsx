    ...
    >
      <div className="rounded-[28px] bg-white p-7 shadow-[0_10px_40px_-16px_rgba(20,30,60,0.25)]">
        <div className="flex items-center gap-3.5">
          <div
            className={cn(
              "flex h-[56px] w-[56px] shrink-0 items-center justify-center overflow-hidden rounded-full text-[20px] font-bold text-white",
...
export async function renderShareCard(node: HTMLElement): Promise<Blob> {
  // Nothing is photographed until every picture in the card has decoded.
  await Promise.all(
