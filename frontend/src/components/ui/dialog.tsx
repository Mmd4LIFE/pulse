...
>(({ className, children, hideClose = false, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {!hideClose && (
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-1.5 text-muted-foreground opacity-80 transition hover:bg-accent hover:opacity-100 focus:outline-none">
          <X className="h-4 w-4" />
